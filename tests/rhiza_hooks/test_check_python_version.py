...
(Hypothesis) invariants for the ``rhiza_hooks.check_python_version`` module.

The end-to-end run through ``pre-commit try-repo`` used to live here, hard-coded
to this one hook. It now covers the whole manifest from
``tests/meta/test_pre_commit_manifest.py`` (issue #295).
"""
